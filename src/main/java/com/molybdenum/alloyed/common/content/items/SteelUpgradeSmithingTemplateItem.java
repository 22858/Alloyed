...
public class SteelUpgradeSmithingTemplateItem extends SmithingTemplateItem {
    ...
    public SteelUpgradeSmithingTemplateItem (Properties properties) {
        super(APPLIES_TO, INGREDIENTS, BASE_SLOT_DESCRIPTION, ADDITIONS_SLOT_DESCRIPTION, createNetheriteUpgradeIconList(), createNetheriteUpgradeMaterialList(), properties);
    }
